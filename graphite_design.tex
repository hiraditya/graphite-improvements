...
tree of natural loops as described in Section-\ref{subsec:induction} and listed in
...
the last loop in an \SESE{.}  Also, regions without loops are excluded if they
...
tree of natural loops.  The number of calls to the dominators and post-dominators
...
\begin {figure}
  ...
  % For controlling the spacing between caption and figure.
  \vspace{-1em}
...
%Add or remove, to prevent overlap of the title REFERENCES with references.
%\mbox{}
