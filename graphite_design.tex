...
the nearest dominator of $dom1$ with single entry because we want to build an
...
basic block also qualifies as post-dominator with single exit. The idea is to
