...
build\_scops and build\_scop\_depth.  Table-\ref{tab:overall-insns} presents the
overall number of instructions executed in the new and old SCoP detection on
several benchmarks: Tramp3d-v4 \cite{richi} is a large C++ application,
Polybench, and all the source files of GCC 6.0.  We also report the speedup in
SCoP detection when compiling the $32$ files of Polybench in
Figure-\ref{fig:polybench-speedup}, and the $578$ files of the source code of
GCC in Figure-\ref{fig:gcc-speedup}.
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{|c|c|c|c|}
      ...
      \hline
      Polybench  & 475127633  & 333775317  & 0.70    \\
      Tramp3d-v4 & 624729992  & 1755147630 & 2.81    \\
      GCC        &            &            &         \\
      \hline
    \end{tabular}
  \end{center}
...
regions that can be represented in the polyhedral model.  These improvements in
compilation time of generic programs ensure that enabling the polyhedral
...
translated in the polyhedral model.
