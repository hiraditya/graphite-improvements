...
%@Sebastian: Following is optional, please add if you like or, if it helps restructuring the enums.

\setlist[enumerate]{itemsep=0.2ex,topsep=2pt,leftmargin=*}
\setlist[itemize]{itemsep=0.2ex,topsep=2pt,leftmargin=*}
