...
\begin {figure}
  ...
  \end{center}
  \caption{Speedup of improved SCoP detection on GCC.  \texttt{Note to the
      reviewers: we have not collected all the data yet: these are only the
      first files in the code of GCC from 'a' to 'c'.  We will add all the data
      for the $578$ files in the final version of the paper.}}
