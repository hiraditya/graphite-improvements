...
new SCoP detection only executed $98822$ instructions, a speedup of $16$.  We
also report the speedup in SCoP detection when compiling the $32$ files of
Polybench in Figure-\ref{fig:polybench-speedup}, and the $578$ files of the
source code of GCC in Figure-\ref{fig:gcc-speedup}.  The overall number of
instructions executed while compiling all the files of GCC in the old SCoP
detection is $29201650$ instructions, and $1044304$ instructions with the new
SCoP detection, a speedup of $28$.
